import { League, MatchResolveType, PeriodType, Provider, ScoringType, Sport, TennisSubLeague } from '../enums/sports';
import { LeagueData } from '../types/sports';

export const LeagueMap: Record<League, LeagueData> = {
    [League.NCAAF]: {
