...
export const BENCHMARKS_PRICE_ENDPOINT = 'https://benchmarks.pyth.network/v1/updates/price/';
...
export const PRICE_UPDATES_PATH = '/v2/updates/price/';
...
export const PYTH_API_RETRIES = 3;
export const PYTH_API_TIMEOUT_MS = 15000;
