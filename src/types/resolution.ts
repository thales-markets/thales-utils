...
export const QUARTERS_PERIOD_TYPE_ID_MAPPING: { [period: number]: number[] } = {
    ...
    6: [10026, 10036, 10046, 10056, 10066, 10076, 10086, 10611, 10612], // 6th period
    7: [10027, 10037, 10047, 10057, 10067, 10077, 10087, 10711, 10712], // 7th period
    8: [10028, 10038, 10048, 10058, 10068, 10078, 10088, 10811, 10812], // 8th period
    9: [10029, 10039, 10049, 10059, 10069, 10079, 10089], // 9th period
};
